...
export const ServerSearch = ({
    ...
    return(
        <>
            ...
            className="group px-2 py-2 rouned-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transitions"> 
                <Search className="w-4 h-4 text-zin-500 dar:text-zinc-400" />
                <p
