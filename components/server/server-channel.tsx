...
export const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    <button onClick={onClick} className={cn("group px-2 py-0 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1", params?.channelId === channel.id && "bg-zinc-700/20 dark:bg-zinc-700")}>
      <Icon
