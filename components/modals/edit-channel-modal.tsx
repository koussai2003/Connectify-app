              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={isLoading} className="bg-zinc-300/50 border-0 focus-visibile:ring-0 text-black focus-visible:ring-offset-0x" placeholder="Enter a channel name" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
